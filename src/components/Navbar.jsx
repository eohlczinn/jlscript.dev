const links = [
  ["Home", "#/"], ["Sobre", "#/sobre"], ["Documentação", "#/docs"], ["Download", "#/download"],
  ["Playground", "#/playground"], ["Biblioteca", "#/biblioteca"], ["Roadmap", "#/roadmap"], ["Suporte", "#/suporte"]
];

export default function Navbar({ route, theme, onThemeChange }) {
  return <nav className="navbar" aria-label="Navegação principal">
    <a className="brand" href="#/"><span>JLS</span>cript</a>
